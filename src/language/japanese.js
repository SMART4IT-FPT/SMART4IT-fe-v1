const japanese = {
    ...
    landing:{
        ...
        aboutcontent1:'SMART4ITでは、キャリアの可能性を解放するためには、全体的なアプローチが必要であることを認識しています。私たちのプラットフォームは、伝統的なCVの提出を超えて、求職者を適切な機会とつなげるための伝達手段として機能します。私たちは、適切な接続があなたのキャリアの旅におけるすべての違いを作ることができると信じています。私たちのプラットフォームは、あなたが今日、あなたの夢の仕事に向けて次のステップを踏み出すための接続を作るのを助けるように設計されています。',
        aboutcontent2:'私たちは、すべての個人が選んだキャリアの軌道で繁栄する権利を主張します。SMART4ITは、ユーザーに仕事の説明との互換性についての洞察を提供し、情報に基づいたキャリアの決定を可能にし、専門的な成長を促進することでユーザーを強化します。私たちのプラットフォームは、あなたが今日、あなたの夢の仕事に向けて次のステップを踏み出すための接続を作るのを助けるように設計されています。',
        contacttitle:'お問い合わせ',
